...
// import { ArrowLeft, FileText, User, Flag, Calendar } from 'lucide-react';
// import { toast } from 'sonner';
// import { Button } from '@/components/ui/button';
// import { Input } from '@/components/ui/input';
// import { Textarea } from '@/components/ui/textarea';
...
//       });
//       setSelectedDate(task.deadline ? new Date(task.deadline) : null);
...
//   // If no team selected, keep existing assignedTo
//   useEffect(() => {
...
//                       >
//                         {formData.assignedTo
//                           ? teamMemberOptions.find((opt) => opt.value === formData.assignedTo)?.label || formData.assignedTo
//                           : 'Select team member'}
//                       </Button>
//                     </PopoverTrigger>
...
//                 <Button
//                   type="submit"
//                   className="w-full md:w-auto bg-primary hover:bg-primary/90 rounded-md"
//                   disabled={loading}
//                 >
//                   Update Task
//                 </Button>
